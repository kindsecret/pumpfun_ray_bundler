...
export class PumpFunSDK {
  ...
  async getTokenPrice(mint: PublicKey) {
  ...
  async getBuyInstructionsBySolAmount(
    ...
    if (index == 0) {
      buyTotalSolBal = buyTotalSolBal + buyAmountSol
      buyAmount = bondingCurveAccount.getBuyPrice(buyTotalSolBal);
    }
    else {
      let currentbuyAmount = bondingCurveAccount.getBuyPrice(buyTotalSolBal)
      buyTotalSolBal = buyTotalSolBal + buyAmountSol
      buyAmount = bondingCurveAccount.getBuyPrice(buyTotalSolBal) - currentbuyAmount
    }
